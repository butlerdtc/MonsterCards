"""V1 of component to print catalogue
Displays a message of what cards were printed. This uses the formatter from
04_card_formatter_v5 to print the whole catalogue to the python console in a
table for aesthetics.
...
card_list = []
for card_name in card_catalogue:
    card_list.append(f"     -   {card_name}")
all_names = "\n".join(card_list)
easygui.msgbox(f"These are the cards in the catalogue:\n\n{all_names}\n\nAll "
               f"cards have been printed to the console", "Catalogue printed")
printed_catalogue = card_formatter_table(card_catalogue, "Card Catalogue")
print(printed_catalogue)
