"""Monster cards  base component V3
Each component gets added after creation and testing. Function added from
component 5. Add and search components were updated for edit function later.
...
def main(catalogue, stat_list):
    ...
    while True:
        ...
        if choice == "Add card":
            ...
            # Edit component will go here
        elif choice == "Search card":
            searched_card_dict, searched = search_card(catalogue,
                                                       "Search catalogue")
