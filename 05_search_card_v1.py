"""V1 of search for a card
Asks user to enter card name then checks if it is in catalogue. Basic program.
Created by Robson Butler - 19/05/24
"""

# Catalogue from 00_monster_base_v1
...
search = input("Please enter the name of the card: ").title()
