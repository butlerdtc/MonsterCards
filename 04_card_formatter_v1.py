"""V1 of card formatter
Basic for loops to format a dictionary to look aesthetically pleasing.
Created by Robson Butler - 16/05/24
"""

# Uses catalogue from 00_monster_base_v1 as a base to write program
...
for card, items in card_catalogue.items():
    # Prints cards name
    print(f"{card}:")
    # Prints each stat and value for each card
